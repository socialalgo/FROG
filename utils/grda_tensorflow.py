...
class GRDA(optimizer.Optimizer):
    ...
    def _prepare(self):
        ...
        l1_diff = c * math_ops.pow(lr, (0.5 + mu)) * math_ops.pow(iter_ + 1., mu) - c * math_ops.pow(lr, (
                    0.5 + mu)) * math_ops.pow(iter_ + 0., mu)
    ...
    def _apply_dense(self, grad, var):
        ...
        # GRDA update
        var_update = state_ops.assign(var, math_ops.sign(v_t) * math_ops.maximum(math_ops.abs(v_t) - l1, 0),
